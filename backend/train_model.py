...
if __name__ == "__main__":
    ...
    synthetic_data = [
        ...
        {
            "instruction": "i have been charged twice",
            "intent": "payment_issue",
            "priority": 1,
        },
        {
            "instruction": "fraud detected on my account",
            "intent": "fraud_report",
            "priority": 1,
        },
        {
            "instruction": "unauthorized transaction report",
            "intent": "fraud_report",
            "priority": 1,
        },
        {
            "instruction": "someone used my credit card",
            "intent": "fraud_report",
            "priority": 1,
        },
        {
            "instruction": "double charge on my statement",
            "intent": "payment_issue",
            "priority": 1,
        },
        {
            "instruction": "please refund duplicate payment",
            "intent": "payment_issue",
            "priority": 1,
        },
        {"instruction": "urgent fraud alert", "intent": "fraud_report", "priority": 1},
        {
            "instruction": "my wallet was stolen",
            "intent": "fraud_report",
            "priority": 1,
        },
        {
            "instruction": "block my account immediately",
            "intent": "fraud_report",
            "priority": 1,
        },
        {
            "instruction": "i lost my wallet help",
            "intent": "fraud_report",
            "priority": 1,
        },
        {
            "instruction": "lost wallet block card",
            "intent": "fraud_report",
            "priority": 1,
        },
        {
            "instruction": "my wallet is lost and i dont remember my password",
            "intent": "fraud_report",
            "priority": 1,
        },
    ]
    ...
    synthetic_normal = [
        ...
        {
            "instruction": "just browsing, thanks for the help",
            "intent": "chit_chat",
            "priority": 3,
        },
        {
            "instruction": "i am just looking around",
            "intent": "chit_chat",
            "priority": 3,
        },
        {
            "instruction": "no help needed just browsing",
            "intent": "chit_chat",
            "priority": 3,
        },
